;;; ig-nord-theme.el --- summary -*- lexical-binding: t -*-
...
(defcustom igloo-foreground "#434C5E" ;; Blue Grey / L800
...
(defcustom igloo-highlight "#D8DEE9" ;; Very Light Grey
  "Highlight color is used to highlight part of the screen."
  :type 'color :group nil)

(defcustom igloo-subtle "#81A1C1" ;; Blue Grey / L50
  "Subtle color is used to suggest a physical area on the screen."
  :type 'color :group nil)

(defcustom igloo-faded "#ADB5BD" ;; Blue Grey / L200
...
;;   "Salient color is used for information that are important."
;;   :type 'color :group nil)
(defcustom igloo-salient "#5E81AC" ;; Deep Blue
  "Salient color is used for information that are important."
  :type 'color :group nil)

(defcustom igloo-strong "#3B4252" ;; Blue Grey / L900
  "Strong color is used for information of a structural nature."
  :type 'color :group nil)

(defcustom igloo-popout "#D08770" ;; Deep Orange / L200
  "Popout colour is used for information that needs attention."
  :type 'color :group nil)

(defcustom igloo-string "#A3BE8C" ;; Lime 
  "Popout colour is used for strings."
  :type 'color :group nil)

(defcustom igloo-critical "#BF616A" ;; Amber / L900
...
(provide-theme 'ig-nord)

(provide 'ig-nord-theme)

;;; ig-nord-theme.el ends here
