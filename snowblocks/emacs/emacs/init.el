...
(custom-set-variables
 ...
 '(package-selected-packages
   '(yaml-mode flucui-themes direnv nord-theme python-mode flycheck yasnippet company-box company lsp-python-ms lsp-ui lsp-mode evil-smartparens evil-nerd-commenter csv-mode which-key major-mode-hydra use-package smex persp-mode ivy-rich hydra general counsel)))
(custom-set-faces
